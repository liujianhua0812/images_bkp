...
val_size = 0.1
#test_size = 0.2
postfix = 'jpg'  # train jpg           test JPG
imgpath = r'C:/Users/GIX/Desktop/PoppyDetection-master/dataset_new/images'    # 划分前图像文件路径
txtpath =  r'C:/Users/GIX/Desktop/PoppyDetection-master/dataset_new/labels'    # 

dataset_path = 'C:/Users/GIX/Desktop/PoppyDetection-master/data' # 划分后数据集路径

output_train_img_folder = dataset_path + '/images/train'
output_val_img_folder = dataset_path + '/images/val'
output_train_txt_folder = dataset_path + '/labels/train'
output_val_txt_folder =  dataset_path + '/labels/val'
